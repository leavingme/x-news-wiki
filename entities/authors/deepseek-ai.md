...
X (Twitter) 作者 [@deepseek_ai](https://x.com/deepseek_ai)，共 **2** 条 AI 精选推文被收录到本知识库。

## 精选推文（按时间倒序）

- [DeepSeek API缓存价格打一折：推理成本战进入「微利时代」](../sources/news/2026-04-26/00__deepseek_ai__deepseek-api缓存价格打一折-推理成本战进入-微利时代.md) — 2026-04-26
- [DeepSeek-V4-Flash：以1/10价格实现1M上下文，开源模型正式撕掉「廉价低能」标签](../sources/highlights/2026-04-24/00__deepseek_ai__deepseek-v4-flash-以1-10价格实现1m上下文-开源模型正式撕掉-廉价低能-标签.md) — 2026-04-24
