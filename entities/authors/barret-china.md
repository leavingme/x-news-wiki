...
X (Twitter) 作者 [@Barret_China](https://x.com/Barret_China)，共 **2** 条 AI 精选推文被收录到本知识库。

## 精选推文（按时间倒序）

- [AI Coding 平权化：程序员画像的强制性重构](../sources/news/2026-03-09/80__Barret_China__ai-coding-平权化-程序员画像的强制性重构.md) — 2026-03-09 (priority 80)
- [Vibe Coding的「蜜月期」结束：规模膨胀触发维护性危机](../sources/highlights/2026-03-09/88__Barret_China__vibe-coding的-蜜月期-结束-规模膨胀触发维护性危机.md) — 2026-03-09 (priority 88)
