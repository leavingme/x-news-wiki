...
X (Twitter) 作者 [@verysmallwoods](https://x.com/verysmallwoods)，共 **3** 条 AI 精选推文被收录到本知识库。

## 精选推文（按时间倒序）

- [Karpathy 实践：LLM 知识库正在替代代码操作成为 Token 消耗主力](../sources/news/2026-04-03/00__verysmallwoods__karpathy-实践-llm-知识库正在替代代码操作成为-token-消耗主力.md) — 2026-04-03
- [Claude Code “口喷模式”来袭：AI 原生工作流将清洗上一代工具市场](../sources/news/2026-03-03/00__verysmallwoods__claude-code-口喷模式-来袭-ai-原生工作流将清洗上一代工具市场.md) — 2026-03-03
- [极速重构：Sessionly 从 Electron 转向 Tauri 的技术倒戈](../sources/news/2026-02-21/00__verysmallwoods__极速重构-sessionly-从-electron-转向-tauri-的技术倒戈.md) — 2026-02-21
