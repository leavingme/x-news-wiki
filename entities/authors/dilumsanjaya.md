...
X (Twitter) 作者 [@DilumSanjaya](https://x.com/DilumSanjaya)，共 **1** 条 AI 精选推文被收录到本知识库。

## 精选推文（按时间倒序）

- [GPT Images 2生成3D生物结构+Gemini编码：多模态工具链的「组合式创作」新范式](../sources/news/2026-05-10/00__DilumSanjaya__gpt-images-2生成3d生物结构-gemini编码-多模态工具链的-组合式创作-新范式.md) — 2026-05-10
