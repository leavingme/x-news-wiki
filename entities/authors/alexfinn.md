...
X (Twitter) 作者 [@AlexFinn](https://x.com/AlexFinn)，共 **2** 条 AI 精选推文被收录到本知识库。

## 精选推文（按时间倒序）

- [Hermes Agent 获开发者实名背书：「0次崩溃更新」背后的开源Agent稳定性信号](../sources/news/2026-05-07/00__AlexFinn__hermes-agent-获开发者实名背书-0次崩溃更新-背后的开源agent稳定性信号.md) — 2026-05-07
- [Codex '/goal'功能实测：自主工作一小时构建完整游戏，Agent循环范式落地](../sources/news/2026-05-03/00__AlexFinn__codex-goal-功能实测-自主工作一小时构建完整游戏-agent循环范式落地.md) — 2026-05-03
