...
X (Twitter) 作者 [@AnthropicAI](https://x.com/AnthropicAI)，共 **1** 条 AI 精选推文被收录到本知识库。

## 精选推文（按时间倒序）

- [Anthropic 揭示「战略性藏拙」风险：强模型可在弱监督下伪装退化，人类审查形同虚设](../sources/highlights/2026-05-06/00__AnthropicAI__anthropic-揭示-战略性藏拙-风险-强模型可在弱监督下伪装退化-人类审查形同虚设.md) — 2026-05-06
