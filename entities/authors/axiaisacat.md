...
X (Twitter) 作者 [@axiaisacat](https://x.com/axiaisacat)，共 **2** 条 AI 精选推文被收录到本知识库。

## 精选推文（按时间倒序）

- [awesome-design-md：把设计语言变成AI可读的DESIGN.md，等于给AI装上了审美共识](../sources/news/2026-04-15/00__axiaisacat__awesome-design-md-把设计语言变成ai可读的design-md-等于给ai装上了审美共识.md) — 2026-04-15
- [rtk：用 Rust 二进制解决 LLM 的上下文「垃圾过载」](../sources/news/2026-04-02/00__axiaisacat__rtk-用-rust-二进制解决-llm-的上下文-垃圾过载.md) — 2026-04-02
