...
X (Twitter) 作者 [@Tradinator33](https://x.com/Tradinator33)，共 **1** 条 AI 精选推文被收录到本知识库。

## 精选推文（按时间倒序）

- [Crypto Agent的幻觉危机：$HEU用一份SKILL.md实现70%工具调用削减](../sources/highlights/2026-03-12/85__Tradinator33__crypto-agent的幻觉危机-heu用一份skill-md实现70-工具调用削减.md) — 2026-03-12 (priority 85)
