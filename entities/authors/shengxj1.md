...
X (Twitter) 作者 [@shengxj1](https://x.com/shengxj1)，共 **1** 条 AI 精选推文被收录到本知识库。

## 精选推文（按时间倒序）

- [王自如48天Vibe Coding实录：零技术背景产出10万行代码，「自然语言编程」进入可验证阶段](../sources/news/2026-03-22/00__shengxj1__王自如48天vibe-coding实录-零技术背景产出10万行代码-自然语言编程-进入可验证阶段.md) — 2026-03-22
