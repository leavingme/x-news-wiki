...
- [W-Flow 单步生成击穿 ImageNet 1.29 FID：字节+斯坦福把扩散压成一帧](../sources/highlights/2026-06-15/00__jiqizhixin__w-flow-单步生成击穿-imagenet-1-29-fid-字节-斯坦福把扩散压成一帧.md) — 2026-06-15 · @jiqizhixin
- [南开南大 WaDi：单步扩散生成图像反超多步 SOTA，蒸馏关键在方向而非幅度](../sources/highlights/2026-06-10/00__jiqizhixin__南开南大-wadi-单步扩散生成图像反超多步-sota-蒸馏关键在方向而非幅度.md) — 2026-06-10 · @jiqizhixin
- [单步扩散突破 0.75 FID 极限：直接优化目标函数的算法红利来了](../sources/highlights/2026-05-01/00__JiaweiYang118__单步扩散突破-0-75-fid-极限-直接优化目标函数的算法红利来了.md) — 2026-05-01 · @JiaweiYang118
