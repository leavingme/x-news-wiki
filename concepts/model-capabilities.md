...
- [清华阿里联合发布 ViT^3：测试时在线学习将视觉模型推理复杂度降为线性](../sources/news/2026-05-26/00__jiqizhixin__清华阿里联合发布-vit-3-测试时在线学习将视觉模型推理复杂度降为线性.md) — 2026-05-26 · @jiqizhixin
- [某新模型架构能力被认可但 RL 训练未适配 Agent Harness，4.1 版本才是关键窗口](../sources/news/2026-05-07/00__oran_ge__某新模型架构能力被认可但-rl-训练未适配-agent-harness-4-1-版本才是关键窗口.md) — 2026-05-07 · @oran_ge
- [Gemini 3.2 Flash 已悄然上线：Google 正在用「静默部署」策略抢占模型迭代节奏](../sources/news/2026-05-05/00__kimmonismus__gemini-3-2-flash-已悄然上线-google-正在用-静默部署-策略抢占模型迭代节奏.md) — 2026-05-05 · @kimmonismus
- [Google COSMO 偷跑：1.13GB 端侧 AI 助手内置 14 项主动能力，I/O 大会前的火力侦察](../sources/highlights/2026-05-02/00__koltregaskes__google-cosmo-偷跑-1-13gb-端侧-ai-助手内置-14-项主动能力-i-o-大会前的火力侦察.md) — 2026-05-02 · @koltregaskes
...
- [GPT-5.5 追平 Opus 4.7：前沿模型能力差距收窄，OpenAI 与 Anthropic 攻守易位](../sources/highlights/2026-04-26/00__op7418__gpt-5-5-追平-opus-4-7-前沿模型能力差距收窄-openai-与-anthropic-攻守易位.md) — 2026-04-26 · @op7418
