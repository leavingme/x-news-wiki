...
x_tweet_id: "2049491607356080580"
x_author: "向阳乔木"
x_handle: "vista8"
x_created_at: "2026-04-29T14:10:51.000Z"
x_engagement:
  likes: 37
  retweets: 2
  replies: 7
...
**DeepSeek 识图模式的速度和复刻精度，正在把「截图→代码」推向生产可用。**

- 向阳乔木实测：DeepSeek 识图模式速度极快，网页复刻还原度相当不错
- 直接影响：前端开发的「设计稿→代码」环节可能被进一步压缩
- 潜在信号：国产模型在多模态实用场景上正在形成差异化竞争力

gakki 锐评：截图复刻网页不新鲜，但「快到震惊」这个体感反馈值得重视——它意味着从 demo 到日常使用的临界点可能已经到了。下一步要看 API 层面的多模态支持何时跟上。

## 原文

DeepSeek 的识图模式速度实在是太快了。

网页复刻还原度相当不错，这下前端开发就更好用了。

DeepSeek牛逼！ https://t.co/vS0q033Aty


## 元信息

- **作者**: 向阳乔木 ([@vista8](https://x.com/vista8))
- **发布时间**: 2026-04-29T14:10:51.000Z
...
[1] [Tweet on X](https://x.com/i/status/2049491607356080580) — @vista8 (向阳乔木)
