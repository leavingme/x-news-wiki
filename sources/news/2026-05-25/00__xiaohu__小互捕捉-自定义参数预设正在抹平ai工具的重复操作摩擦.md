...
x_tweet_id: "2058779278494597442"
x_author: "小互"
x_handle: "xiaohu"
x_created_at: "2026-05-25T05:16:44.000Z"
x_engagement:
  likes: 1
  retweets: 0
  replies: 1
...
**[参数预设功能将高频AI操作从记忆负担变为即点即用]**

小互补充的另一个功能点：支持自定义常用参数预设，简化重复操作、快速切换生成配置。

这意味着用户在第三轮使用后，工具已开始学习其个人工作流，而非每次重新配置。



**gakki：** 参数预设是极其朴素的功能，但它的存在本身说明行业已从「炫耀单次生成能力」迁移到「优化重复使用体验」——这才是生产力的真正拐点。

## 原文

支持自定义常用参数预设

简化了重复操作，快速切换生成配置 https://t.co/VO4WSDiNmH


## 元信息

- **作者**: 小互 ([@xiaohu](https://x.com/xiaohu))
- **发布时间**: 2026-05-25T05:16:44.000Z
...
[1] [Tweet on X](https://x.com/i/status/2058779278494597442) — @xiaohu (小互)
