...
tags:
  ...
  - "highlights"
  - "author:dotey"
timestamp: "2026-05-01T16:18:55.561Z"
x_tweet_id: "2050245815852056837"
x_author: "宝玉"
x_handle: "dotey"
x_created_at: "2026-05-01T16:07:48.000Z"
x_engagement:
  likes: 4
  retweets: 0
  replies: 3
...
**苹果在 Apple Support App v5.13 的发布包里把 Claude.md 一起发出来了。**

- 不是外部开发者，是苹果自己的工程团队在用 Claude Code 的工作流配置文件
- Claude.md 是 Claude Code 的项目级指令文件，泄露意味着苹果内部已将 Claude 深度集成到开发流程
- 继「宝玉身体诚实」之后，这是大厂层面最硬的 Claude 渗透证据

gakki 锐评：苹果嘴上不说用谁家 AI，脚已经踩在 Claude 的工作流里了。这比任何「战略合作公告」都真实。
...
- **发布时间**: 2026-05-01T16:07:48.000Z
- **抓取时间**: 2026-05-01T16:18:55.561Z
- **精选类别**: ✨ 亮点
- **优先级**: 0
- **互动**: ❤️ 4 · 🔄 0 · 💬 3 · 🔖 0 · 👁 0
...
[1] [Tweet on X](https://x.com/i/status/2050245815852056837) — @dotey (宝玉)
