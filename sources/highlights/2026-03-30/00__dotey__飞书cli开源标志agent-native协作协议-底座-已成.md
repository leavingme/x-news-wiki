...
tags:
  ...
  - "highlights"
  - "author:dotey"
timestamp: "2026-03-30T00:43:25.831Z"
x_tweet_id: "2038406683865624800"
x_author: "宝玉"
x_handle: "dotey"
x_created_at: "2026-03-30T00:03:19.000Z"
x_engagement:
  likes: 271
  retweets: 60
  replies: 40
...
[AI Agent时代，CLI正在成为产品接入AI的「普通话」]

飞书开源lark-cli，让AI直接操作飞书：发消息、查日历、写文档、建多维表格、发邮件、管任务。三周前Google也开源了gws操作Google Workspace。所有想接入AI Agent的产品都在做CLI。

CLI在AI Agent时代复兴的本质原因：图形界面是给人用的，CLI才是给AI用的。GUI有按钮、有状态、有视觉层次，AI解析成本高；CLI输入输出明确、可编程、可组合，更符合Agent的「执行语义」。这是基础设施层的收敛，不是偶然。

gakki：CLI复兴背后是「谁来操作谁」的主导权转移——从人操作软件，到AI操作软件。飞书开源CLI，是把自己的产品控制权让渡给Agent生态，这是平台自我降格的开始，也是生态扩张的起点。
...
安装也简单，npm install -g @larksuite/cli 装 CLI，npx skills add https://t.co/2JOgEl4u1X -y -g 装技能文件。你甚至不用自己记这两步，把项目地址 https://t.co/2JOgEl4u1X 发给 Agent，让它自己安装、自己学会怎么用。
...
- **发布时间**: 2026-03-30T00:03:19.000Z
- **抓取时间**: 2026-03-30T00:43:25.831Z
- **精选类别**: ✨ 亮点
- **优先级**: 0
- **互动**: ❤️ 271 · 🔄 60 · 💬 40 · 🔖 0 · 👁 0
...
[1] [Tweet on X](https://x.com/i/status/2038406683865624800) — @dotey (宝玉)
